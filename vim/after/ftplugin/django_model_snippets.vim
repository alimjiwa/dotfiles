...
exec "Snippet mmodel class ".st.et."(models.Model):<CR>\"\"\"".st.et."\"\"\"<CR>".st.et." = ".st.et."<CR><CR>def __unicode__(self):<CR>return \"".st.et."\" % (".st.et.")<CR>".st.et
exec "Snippet mauto models.AutoField(primary_key=".st."True".et.st.et.")".st.et
...
exec "Snippet mfloat models.FloatField(".st.et.")".st.et
